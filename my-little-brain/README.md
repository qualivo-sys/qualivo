...
| **Ajuste de calorias** | Cada dos semanas compara la tendencia real de peso con el ritmo objetivo y propone un cambio concreto ("toca bajar 200 kcal"), aplicable con un toque. Solo con datos suficientes (4 pesajes y 7 dias de comidas en dos semanas) y nunca sobre una dieta de un especialista. Motor en `src/lib/motor/ajuste.ts`. |
| **Comidas habituales** | Lo que sueles comer, a un toque: la app agrupa tu historial, promedia las calorias y te ofrece primero lo que comes a esa hora del dia. En Hoy y en Cuerpo. |
...
| **Energia y semana** | Balance del dia: gastado (basal, pasos, fuerza, cardio, actividades) frente a comido, con lectura segun el objetivo. Actividades fuera del plan (monte, bici, padel…) con calorias por MET. Calendario semanal con entrenos, actividades, comido, gastado, pasos y dias redondos. Al terminar un entreno: XP, racha y boton de compartir; "dia redondo" (+30 XP) cuando coinciden entreno, calorias y proteina. |
