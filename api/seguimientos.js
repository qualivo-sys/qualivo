...
const REGLAS = [
  ...
  { patron: /no presentad/, dias: 2, clave: 'nopresentado-2', prioridad: true,
    titulo: 'No vino a la reunión y sigue sin nueva fecha',
    accion: 'Dos días desde que no se presentó. Un mensaje corto con dos huecos concretos; si no contesta, llamada de Raquel. A la tercera sin respuesta, a «Más adelante» con motivo.' },
