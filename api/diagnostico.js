  ...
  try {
    ...
    if (cualificado && contactId && telefono) {
      try {
        ...
        await act.etiquetar(contactId, ['act-wa1'].concat(env.canal === 'sms' ? ['act-por-sms'] : env.canal === 'plantilla' ? ['act-por-plantilla'] : env.canal === 'whatsapp_fallido' ? ['act-wa1-fallido'] : []));
      } catch (err) {
