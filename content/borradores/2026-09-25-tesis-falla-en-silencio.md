# Viernes 25 · tesis contraria · «Una automatización que falla en silencio sale más cara que no tenerla»

> Pieza del día según la rutina (viernes: tesis contraria). LinkedIn, texto con
> la imagen `content/infografias/2026-09-25/falla-en-silencio.png`. La misma
> imagen en Instagram con el pie corto. **Sin publicar**: la pausa sigue en
> LinkedIn, y en Instagram hace falta el ok de Maikel pieza a pieza.

## Ficha

- **Serie:** tesis contraria (Construyendo Qualivo). **Etapa:** contacto.
- **Tesis:** una automatización que falla en silencio sale más cara que no tenerla.
- **Dato real:** daily de Growth del 24-sep (`bus/out/demand.jsonl`). El primer
  mensaje automático a los contactos nuevos estuvo casi dos días sin salir
  (del 22 al 24 de septiembre por la tarde) porque un interruptor se quedó en
  pausa. La etiqueta de «enviado» se ponía igual, así que el panel parecía
  normal. Lo detectó Maikel al ver una captura, no por ninguna alerta. Se
  arregló el mismo día: ahora el envío está activo por defecto y solo se
  pausa si alguien lo pide de forma explícita.
- **Lo que NO se cuenta, a propósito:** que ese mensaje es un WhatsApp (regla
  del 21-sep sobre el 663) y el mensaje que salió cruzado a otro contacto al
  reactivarse (afecta a datos de un tercero).
...
> es más peligrosa: hace que dejes de mirar.
>
...
>
> #automatizacion #pymes #ventas #sistemas
