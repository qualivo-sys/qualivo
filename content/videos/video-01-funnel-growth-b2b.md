...
## TÍTULO
**Cómo construir un funnel de growth B2B (y encontrar dónde pierde dinero el tuyo)**
...
## HOOK (primeros 20-30 segundos — la idea, no el guion)
Cámara directa, sin intro, sin logo:
...
Dibujar o mostrar el gráfico (G1): Visita → Lead → Oportunidad → Venta → Repetición. Y decir: «las cajas dan igual; mirad las flechas».
- **Flecha 1 (visita→lead):** ¿qué % deja sus datos? ¿dónde exactamente se caen?
- **Flecha 2 (lead→oportunidad):** aquí viven las dos fugas más caras — cualificación (entran curiosos) y velocidad (se contacta tarde).
- **Flecha 3 (oportunidad→venta):** tasa de cierre POR CANAL de origen. Una media esconde el problema.
...
1. Dibuja TUS etapas reales, no las de un manual.
2. Cuenta personas por etapa del último trimestre.
3. Calcula el % de cada transición y compáralo ENTRE CANALES (tu benchmark eres tú).
4. Ponle precio a la peor flecha: ¿cuántas ventas más habría con la conversión del canal bueno?
5. Arregla UNA cosa. La que más dinero devuelve. Y mide el antes/después.
- Advertencia honesta: «¿y si no tienes ni CRM ni datos? Entonces no optimices: construye. Es otro proyecto y no pasa nada por admitirlo.»

### 5. Conclusión (min 12-13)
- «Tener piezas no es tener sistema. El sistema es lo que las conecta — y el funnel medido es el mapa de esas conexiones.»
- «La mayoría de las empresas que analizo no necesitaba más leads. Necesitaba dejar de perder los que ya pagaba.»

### 6. CTA (suave, 15 seg)
- «Si quieres saber por qué flecha se te escapa el dinero, en la descripción tienes un auto-diagnóstico de 3 minutos. Gratis, sin dejar el correo siquiera. Y si quieres que lo miremos con tus números, ya sabes dónde estoy.»
...
## MICROCÁPSULAS (10)
Formato de cada una: Hook / Idea / Desarrollo (2-3 frases habladas) / Cierre / Visual / Caption.
...
8. **«Las dos fugas más caras viven en la misma flecha»** — Lead→oportunidad: cualificación y velocidad. Desarrollo: curiosos dentro + contacto tardío. Cierre: «ahí miro yo primero, siempre». Visual: G1 con zoom a la flecha 2.
9. **«Arregla UNA cosa»** — La que más dinero devuelve, no la más visible. Desarrollo: tres arreglos a la vez = no saber cuál funcionó. Visual: G2 tachando.
10. **«Tener piezas no es tener sistema»** — La frase de la casa. Desarrollo: CRM+agencia+campañas sin conexión = pestañas abiertas. Cierre: el sistema es lo que las conecta. Visual: cámara, cierre del vídeo.
