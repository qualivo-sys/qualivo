...
function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addSeparator()
    .addSubMenu(SpreadsheetApp.getUi().createMenu('Instagram ABM')
      .addItem('Crear / actualizar hojas IG', 'setupInstagramAbm')
      .addItem('Extraer de Apify → IG_Contactos', 'menuScrapeInstagram')
      .addItem('Rehospedar fotos en Drive', 'menuRehostIgPhotos')
      .addSeparator()
      .addItem('Generar cola de hoy (DMs)', 'menuBuildDmQueue')
      .addItem('Marcar enviados', 'menuConfirmDmSent'))
    .addSeparator()
