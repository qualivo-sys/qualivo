...
> ℹ️ **Herramienta interna de Qualivo (aparte de EAC):** el análisis de
> carruseles virales de la competencia vive en `qualivo-swipe/` como una
> herramienta **autónoma** (Sheet propio de Qualivo, un solo archivo). No forma
> parte del dashboard de EAC. Ver [`qualivo-swipe/README.md`](qualivo-swipe/README.md).
