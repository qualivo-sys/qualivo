...
const SYSTEM = `Trabajas para Agent for Me, que monta equipos digitales dentro de empresas: cada empleado digital ocupa un puesto con un rol, tareas y horas claras.
