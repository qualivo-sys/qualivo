// Recibe el resultado del Company Scan de agenttome.io y crea/actualiza el
  ...
  try {
    const upsertRes = await fetch(GHL_BASE + '/contacts/upsert', {
      ...
      body: JSON.stringify({
        ...
        email: email,
        companyName: empresa,
        source: 'agenttome.io — Company Scan',
        tags: ['atm-scan', 'origen-agenttome', 'scan-' + recomendado]
      })
    });
    if (!upsertRes.ok) {
